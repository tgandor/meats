    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == exportFilename) {//GEN-BEGIN:|7-commandAction|1|110-preAction
            if (command == cancelCommand1) {//GEN-END:|7-commandAction|1|110-preAction
                ...
                if ( message != null ) {
                    getMainMenu().setTicker(new Ticker(message));
                } else {
                    getMainMenu().setTicker(null);
                }
...
//GEN-LINE:|7-commandAction|12|87-postAction
 ...
 // write post-action user code here
            ...
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|21|100-preAction
                ...
                // write post-action user code here
            } else if (command == itemCommand2) {//GEN-LINE:|7-commandAction|25|107-preAction
                // write pre-action user code here
                switchDisplayable(null, getExportFilename());//GEN-LINE:|7-commandAction|26|107-postAction
                // write post-action user code here
