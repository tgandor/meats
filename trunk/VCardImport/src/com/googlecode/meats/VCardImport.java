...
//GEN-LINE:|7-commandAction|8|87-postAction
 ...
 // write post-action user code here
            ...
            if (command == backCommand2) {//GEN-END:|7-commandAction|13|93-preAction
                // write pre-action user code here
                switchDisplayable(null, getMainMenu());//GEN-LINE:|7-commandAction|14|93-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|15|116-preAction
        } else if (displayable == vCardsFound) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|15|116-preAction
 // write pre-action user code here
                vCardsFoundAction();//GEN-LINE:|7-commandAction|16|116-postAction
 // write post-action user code here
            } else if (command == backCommand4) {//GEN-LINE:|7-commandAction|17|119-preAction
 // write pre-action user code here
                switchDisplayable(null, getMainMenu());//GEN-LINE:|7-commandAction|18|119-postAction
 showNotification(null);
            }//GEN-BEGIN:|7-commandAction|19|83-preAction
        } else if (displayable == welcome) {
            if (command == backCommand) {//GEN-END:|7-commandAction|19|83-preAction
 // write pre-action user code here
                switchDisplayable(null, getMainMenu());//GEN-LINE:|7-commandAction|20|83-postAction
 // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|21|100-preAction
        } else if (displayable == writableDirs) {
            if (command == List.SELECT_COMMAND) {//GEN-END:|7-commandAction|21|100-preAction
                // write pre-action user code here
                writableDirsAction();//GEN-LINE:|7-commandAction|22|100-postAction
                // write post-action user code here
            } else if (command == backCommand3) {//GEN-LINE:|7-commandAction|23|103-preAction
                // write pre-action user code here
                switchDisplayable(null, getMainMenu());//GEN-LINE:|7-commandAction|24|103-postAction
                // write post-action user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: okCommandDiag ">//GEN-BEGIN:|57-getter|0|57-preInit
    /**
     * Returns an initialized instance of okCommandDiag component.
     *
     * @return the initialized component instance
     */
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: formDiag ">//GEN-BEGIN:|55-getter|0|55-preInit
    /**
     * Returns an initialized instance of formDiag component.
     *
     * @return the initialized component instance
     */
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: vCard ">//GEN-BEGIN:|91-getter|0|91-preInit
    /**
     * Returns an initialized instance of vCard component.
     *
     * @return the initialized component instance
     */
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: writableDirs ">//GEN-BEGIN:|99-getter|0|99-preInit
    /**
     * Returns an initialized instance of writableDirs component.
     *
     * @return the initialized component instance
     */
...
//<editor-fold defaultstate="collapsed" desc=" Generated Method: writableDirsAction ">//GEN-BEGIN:|99-action|0|99-preAction
    ...
    public void writableDirsAction() {//GEN-END:|99-action|0|99-preAction
        ...
        switchDisplayable(null, getExportFilename());
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: exportFilename ">//GEN-BEGIN:|105-getter|0|105-preInit
    /**
     * Returns an initialized instance of exportFilename component.
     *
     * @return the initialized component instance
     */
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: vCardsFound ">//GEN-BEGIN:|115-getter|0|115-preInit
    /**
     * Returns an initialized instance of vCardsFound component.
     *
     * @return the initialized component instance
     */
